...
<body>
    ...
    <form runat="server">
        ...
        <asp:RequiredFieldValidator ForeColor="Red" runat="server" ControlToValidate="fullName" ErrorMessage="Must not be empty!" />
        <br />
        ...
        <asp:RangeValidator ForeColor="Red" runat="server" ControlToValidate="age" Type="Integer" ErrorMessage="Must be within 0 to 100!" MinimumValue="0" MaximumValue="100" />
        <br />
        ...
        <asp:RegularExpressionValidator ForeColor="Red" runat="server" ControlToValidate="email" ValidationExpression="^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$" ErrorMessage="Must input a valid email!" />
        <br />
        ...
        <asp:CompareValidator ForeColor="Red" runat="server" ControlToValidate="confirmEmail" ControlToCompare="email" ValueToCompare="confirmEmail" ErrorMessage="Emails do not match!" />
        <br />
        <asp:Button Text="Submit" runat="server" UseSubmitBehavior="true" OnClick="Display" /><br /><br />
